...
@JsonPropertyOrder(value = { "DAY1", "HH", "ENODEBID_CELLID", "ECELLNAME_CN", "ECELLNAME", "无线接通率", "无线掉线率", "切换成功率", "流量GB", "RRC加ERAB失败总次数",
		"拥塞次数", "平均激活用户数", "最大激活用户数", "无线掉线率分子", "上行干扰", "RRC连接建立成功率", "ERAB建立成功率", "ERAB掉线率", "上行流量GB", "下行流量GB",
		"上行PRB平均利用率", "下行PRB平均利用率", "小区可用率", "RRC最大连接数", "RRC连接总数", "ENODEB寻呼数", "RRC连接建立请求次数", "RRC连接建立成功次数",
		"RRC连接建立失败次数", "ERAB建立请求数", "ERAB建立成功数", "ERAB建立失败数", "无线掉线率分母", "ERAB掉线次数", "ERAB掉线率分母", "切换请求次数", "切换成功次数",
		"切换失败次数", "小区可用率分子", "小区可用率分母", "上行PDCP平均速率KBPS","下行PDCP平均速率KBPS", "ENB间切换成功次数", "ENB间切换数", "ENB间切换成功率", "ENB内切换成功次数", "ENB内切换数",
		"ENB内切换成功率", "用户面PDCP流量", "VOLTE接通率", "VOLTE话务量", "VOLTE掉话次数", "VOLTE掉话分母", "VOLTE掉话率", "ESRVCC切换请求次数",
		"ESRVCC切换成功次数", "ESRVCC切换失败次数", "ESRVCC切换成功率", "ESRVCC切换准备次数", "ESRVCC切换失败总次数", "VOLTE接入请求次数", "VOLTE接入成功次数",
		"VOLTE接入失败次数", "OMC", "IP", "基站状态", "链路测试时间", "小区管理状态", "小区操作状态", "日常公司", "VIP", "基站类别", "区域", "SDATE"})
public class HourTopCellworkBase {
	@JsonProperty("DAY1")
	private String DAY1;
	@JsonProperty("HH")
	private String HH;

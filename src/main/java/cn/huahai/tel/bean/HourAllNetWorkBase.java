 ...
 *
 */
@JsonPropertyOrder(value = { "DAY1", "HH", "无线接通率", "无线掉线率", "切换成功率", "流量GB", "RRC加ERAB失败总次数", "拥塞次数", "平均激活用户数",
		...
		"ESRVCC切换成功率", "ESRVCC切换请求次数", "ESRVCC切换成功次数", "ESRVCC切换失败次数", "ESRVCC切换准备次数", "ESRVCC切换失败总次数", "VOLTE接入请求次数",
		"VOLTE接入成功次数", "VOLTE接入失败次数", "SDATE"})
public class HourAllNetWorkBase {
	@JsonProperty("DAY1")
	private String DAY1;
	@JsonProperty("HH")
	private String HH;

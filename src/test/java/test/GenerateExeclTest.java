...
public class GenerateExeclTest {
	private static final String EXCEL_XLS = "xls";
	private static final String EXCEL_XLSX = "xlsx";

	/**
	 * 
	 * @param dataList 需要写入excel的数据
	 * @param finalXlsxPath 模板路径
	 */
...
//		m.put("BankName", "zhuo");
//		m.put("Addr", "hua");
//		m.put("Phone", "zhuoaddd");
//		dataList.add(m);
//		dataList.add(m);
//		dataList.add(m);
//		dataList.add(m);
//		GenerateExeclTest.writeExcel(dataList, "F:\\model.xlsx");
		Map<String, String> m = new HashMap<String, String>();
		m.put("BankName", "zhuo");
		m.put("Addr", "hua");
		m.put("Phone", "zhuoaddd");
		...
		m.get("BankName");
		System.out.println(m.get("BankName"));
